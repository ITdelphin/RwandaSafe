        ...
        <div style={{ padding: '24px 32px 32px' }}>
          {sent ? (
            <div style={{ textAlign: 'center', padding: '8px 0' }}>
              <div style={{ width: '56px', height: '56px', borderRadius: '50%', backgroundColor: '#ede9fe', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            ...
            <>
              ...
              <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <button type="submit" disabled={loading || !email}
                  style={{ width: '100%', padding: '13px', borderRadius: '12px', border: 'none', background: loading ? '#94a3b8' : BTN_GRADIENT, color: '#fff', fontWeight: 600, fontSize: '14px', cursor: loading || !email ? 'not-allowed' : 'pointer', opacity: !email ? 0.6 : 1, boxShadow: '0 4px 12px rgba(76,29,149,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
