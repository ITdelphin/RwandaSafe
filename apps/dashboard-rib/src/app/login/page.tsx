...
import { Search, Eye, EyeOff, AlertCircle, Lock, Info } from 'lucide-react';
import { authApi } from '../../lib/apiClient';
import { useAuthStore } from '../../store/authStore';

const AGENCY = { name: 'Rwanda Investigation Bureau', role: 'Investigation Portal', color: '#9334E6' };
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          <div style={{ width: '60px', height: '60px', borderRadius: '16px', backgroundColor: AGENCY.color, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px', boxShadow: `0 4px 14px ${AGENCY.color}40` }}>
        ...
        {/* Info banner */}
        <div style={{ backgroundColor: '#FAF5FF', border: '1px solid #E9D5FF', borderRadius: '12px', padding: '12px 14px', marginBottom: '16px', display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
        ...
        <div style={{ backgroundColor: '#ffffff', borderRadius: '16px', padding: 'clamp(20px,5vw,32px)', boxShadow: '0 2px 16px rgba(0,0,0,0.08)', border: '1px solid #e8eaed' }}>
          ...
          <p style={{ fontSize: '13px', color: '#5f6368', margin: '0 0 20px' }}>Activated investigators only. Enter your credentials.</p>
          ...
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#5f6368', marginTop: '18px', marginBottom: 0 }}>
            New investigator?{' '}<Link href="/register" style={{ color: AGENCY.color, fontWeight: 600, textDecoration: 'none' }}>Register here</Link>
          </p>
        </div>
