        ...
        <div style={{ padding: '24px 32px 32px' }}>
          {success ? (
            ...
            <>
              ...
              <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '20px' }}>Register as an RIB investigator</p>
              <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                <div>
                  ...
                  <input type="text" value={name} onChange={e => setName(e.target.value)} required minLength={2}
                    placeholder="Investigator Alice Mukamana" style={inputStyle}
                ...
                <div>
                  ...
                  <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                    placeholder="investigator@rib.gov.rw" style={inputStyle}
                    onFocus={e => { e.target.style.borderColor = LINK_COLOR; e.target.style.backgroundColor = '#fff'; }}
                    onBlur={e => { e.target.style.borderColor = '#e5e7eb'; e.target.style.backgroundColor = '#f9fafb'; }} />
                </div>
                <div>
