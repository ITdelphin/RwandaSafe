...
export const FIRE_TYPE_ICONS: Record<string, string> = {
  STRUCTURAL_FIRE: 'Structural Fire', VEHICLE_FIRE: 'Vehicle Fire', WILDFIRE: 'Wildfire',
  GAS_LEAK: 'Gas Leak', CHEMICAL_SPILL: 'Chemical Spill', EXPLOSION: 'Explosion',
  RESCUE_TRAPPED: 'Rescue Trapped', ELECTRICAL_FIRE: 'Electrical Fire', OTHER: 'Other',
};
...
export const EVIDENCE_TYPE_ICONS: Record<string, string> = {
  ...
  PHYSICAL_DESCRIPTION: 'Physical Description', WITNESS_STATEMENT: 'Witness Statement', OTHER: 'Other',
};
