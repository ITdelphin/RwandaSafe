...
import { Search, Bell, Moon, Sun, RefreshCcw } from 'lucide-react';
    ...
    <header className="h-16 bg-white flex items-center justify-between px-6 flex-shrink-0 z-30"
      ...
      <div className="flex items-center gap-6 flex-1 min-w-0">
        ...
        <div className="max-w-md w-full relative hidden md:block">
          ...
          <input
            type="text"
            placeholder="Search records, officers, or data..."
            className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500/50 transition-all"
          />
        </div>
      </div>
