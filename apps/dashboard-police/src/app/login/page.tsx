  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (user.role === 'CITIZEN') {
        setError('This portal is for officers only. Please use the citizen app.');
        return;
      }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 flex-col items-center justify-center p-12" style={{ backgroundColor: '#0D1B2A' }}>
        <div className="text-center">
          ...
          <p className="text-blue-300 text-lg">Rwanda National Police</p>
          <p className="text-blue-400 mt-1">Officer Portal</p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-sm">
          <h2 className="text-2xl font-bold text-gray-900 mb-1">Officer Login</h2>
