    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '32px 32px 24px', textAlign: 'center', background: HEADER_GRADIENT }}>
          ...
          <p style={{ fontSize: '13px', color: ACCENT_COLOR, marginTop: '4px' }}>King Faisal Hospital SAMU &middot; Medical Portal</p>
        </div>

        {/* Form body */}
        <div style={{ padding: '24px 32px 32px' }}>
          <h2 style={{ fontSize: '18px', fontWeight: 600, color: '#1f2937', margin: '0 0 4px' }}>Welcome back</h2>
          <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '24px' }}>Sign in to your medical staff account</p>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                  ...
                  style={{
                    ...
                    paddingLeft: '36px', paddingRight: '16px', paddingTop: '12px', paddingBottom: '12px',
