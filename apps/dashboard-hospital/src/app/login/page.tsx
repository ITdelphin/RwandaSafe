...
import { Stethoscope, Eye, EyeOff, AlertCircle, Lock, Info } from 'lucide-react';
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        {/* Info banner */}
        <div style={{ backgroundColor: '#F0FDF4', border: '1px solid #BBF7D0', borderRadius: '12px', padding: '12px 14px', marginBottom: '16px', display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
        ...
        <div style={{ backgroundColor: '#ffffff', borderRadius: '16px', padding: 'clamp(20px,5vw,32px)', boxShadow: '0 2px 16px rgba(0,0,0,0.08)', border: '1px solid #e8eaed' }}>
          ...
          <p style={{ fontSize: '13px', color: '#5f6368', margin: '0 0 20px' }}>Activated medical staff only. Enter your credentials.</p>
          ...
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#5f6368', marginTop: '18px', marginBottom: 0 }}>
            New medical staff?{' '}<Link href="/register" style={{ color: AGENCY.color, fontWeight: 600, textDecoration: 'none' }}>Register here</Link>
          </p>
        </div>
