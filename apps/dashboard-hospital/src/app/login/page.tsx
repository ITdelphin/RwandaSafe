...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left branded panel */}
      <div className="hidden lg:flex lg:w-2/5 flex-col items-center justify-center p-12" style={{ backgroundColor: '#1A0000' }}>
        <div className="text-center max-w-xs">
          ...
          <p className="text-lg font-medium mb-1" style={{ color: '#F87171' }}>King Faisal Hospital SAMU</p>
          <p className="text-sm mb-10" style={{ color: '#FCA5A5' }}>Medical Response Portal</p>
          <div className="space-y-4 text-left">
            {[
              { icon: '🚑', text: 'Ambulance dispatch & tracking' },
              { icon: '🏥', text: 'Hospital capacity management' },
              { icon: '💉', text: 'Triage & medical case handling' },
            ].map(({ icon, text }) => (
              <div key={text} className="flex items-center gap-3">
                <span className="text-xl">{icon}</span>
                <span className="text-sm" style={{ color: '#FECACA' }}>{text}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">Sign in to your medical staff account</p>
          </div>
