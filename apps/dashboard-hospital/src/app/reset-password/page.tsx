          ...
          {!token ? (
            ...
            <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <button type="submit" disabled={loading || password !== confirm}
                style={{ width: '100%', padding: '13px', borderRadius: '12px', border: 'none', background: loading ? '#94a3b8' : BTN_GRADIENT, color: '#fff', fontWeight: 600, fontSize: '14px', cursor: loading || password !== confirm ? 'not-allowed' : 'pointer', opacity: password !== confirm ? 0.6 : 1, boxShadow: '0 4px 12px rgba(198,40,40,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
